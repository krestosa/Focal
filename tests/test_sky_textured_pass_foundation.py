...
VERTEX = ROOT / "shaders" / "gbuffers_skytextured.vsh"
FRAGMENT = ROOT / "shaders" / "gbuffers_skytextured.fsh"


class SkyTexturedPassFoundationTests(unittest.TestCase):
    def test_program_has_required_stages(self) -> None:
    ...
    def test_fragment_stage_samples_tints_and_alpha_tests(self) -> None:
        ...
        self.assertIn("if (skySample.a < 0.1)", source)
