...
VERTEX = ROOT / "shaders" / "gbuffers_hand.vsh"
FRAGMENT = ROOT / "shaders" / "gbuffers_hand.fsh"


def test_hand_program_stages_exist() -> None:
    assert VERTEX.is_file()
    assert FRAGMENT.is_file()


def test_hand_vertex_stage_has_expected_interfaces() -> None:
...
def test_hand_fragment_stage_is_bounded_and_lit() -> None:
