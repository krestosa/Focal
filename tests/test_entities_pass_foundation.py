...
VERTEX = ROOT / "shaders" / "gbuffers_entities.vsh"
FRAGMENT = ROOT / "shaders" / "gbuffers_entities.fsh"


def test_entities_program_stages_exist() -> None:
    assert VERTEX.is_file()
    assert FRAGMENT.is_file()


def test_entities_vertex_stage_has_expected_interfaces() -> None:
...
def test_entities_fragment_stage_is_bounded_and_lit() -> None:
