...
- Baseline audited: `68740126a63e1957d32a1c76420906fae42c7db8`
- Roadmap schema revision: `16`
...
`GLCLI-004/005 minimum runtime path`: compile and link prepared source in a real context, then execute the first deterministic framebuffer draw and readback without claiming Iris-client equivalence.
